...
Настенный светильник "Ворон с лампой" – это не просто источник света, а настоящий арт-объект, который преобразит любое помещение. Идеальное сочетание функциональности и эстетики.`,
  features: [
