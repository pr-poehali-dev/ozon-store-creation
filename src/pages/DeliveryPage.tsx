...
const DeliveryPage = () => (
  <div className="max-w-4xl mx-auto space-y-6 animate-fade-in">
    ...
    <h2 className="text-2xl sm:text-3xl font-bold">Доставка и оплата</h2>

    <Card className="p-4 sm:p-6">
      <div className="flex items-start gap-3 mb-3">
        <Icon name="Package" size={24} className="text-primary mt-0.5 flex-shrink-0" />
        <h3 className="text-lg sm:text-xl font-semibold">Самовывоз со склада в Санкт-Петербурге</h3>
      </div>
      <p className="text-muted-foreground leading-relaxed">
        Мы рады предложить нашим клиентам удобную услугу – самовывоз из нашего склада, расположенного в Санкт-Петербурге. Это отличная возможность получить ваш заказ оперативно и без лишних затрат на доставку. Адрес самовывоза: <strong>г. Санкт-Петербург, Уральская ул., 19к9Ж, офис 409</strong>. Работаем для вас <strong>10:00–19:00</strong>. Перед приездом, пожалуйста, убедитесь, что ваш заказ готов к отгрузке, связавшись с нами по телефону <strong>8 921 636-36-08</strong> или через форму на сайте.
      </p>
    </Card>

    <Card className="p-4 sm:p-6">
      <div className="flex items-start gap-3 mb-3">
        <Icon name="Truck" size={24} className="text-primary mt-0.5 flex-shrink-0" />
        <h3 className="text-lg sm:text-xl font-semibold">Доставка по Санкт-Петербургу</h3>
      </div>
      <p className="text-muted-foreground leading-relaxed">
    ...
    <Card className="p-4 sm:p-6">
      <div className="flex items-start gap-3 mb-3">
        <Icon name="MapPin" size={24} className="text-primary mt-0.5 flex-shrink-0" />
        <h3 className="text-lg sm:text-xl font-semibold">Доставка по Ленинградской области</h3>
      </div>
      <p className="text-muted-foreground leading-relaxed">
    ...
    <Card className="p-4 sm:p-6">
      <div className="flex items-start gap-3 mb-3">
        <Icon name="Globe" size={24} className="text-primary mt-0.5 flex-shrink-0" />
        <h3 className="text-lg sm:text-xl font-semibold">Доставка по России</h3>
      </div>
      <p className="text-muted-foreground leading-relaxed">
