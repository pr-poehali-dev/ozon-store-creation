...
const productData: ProductDetail = {
  ...
  price: 370,
  images: [
    'https://cdn.poehali.dev/projects/c6e71b0f-7d20-4c00-9607-09b4ebf43fcc/bucket/d2467f79-e535-47e1-b732-cb13045315ba.JPG',
    'https://cdn.poehali.dev/projects/c6e71b0f-7d20-4c00-9607-09b4ebf43fcc/bucket/af07c4c9-c3e0-4711-880f-6b2520b9fece.JPG',
    'https://cdn.poehali.dev/projects/c6e71b0f-7d20-4c00-9607-09b4ebf43fcc/bucket/25537f8e-27dc-4684-961d-b14152af44c0.png',
    'https://cdn.poehali.dev/projects/c6e71b0f-7d20-4c00-9607-09b4ebf43fcc/bucket/c2ddb368-da5e-4915-bd74-323914b43388.png',
    'https://cdn.poehali.dev/projects/c6e71b0f-7d20-4c00-9607-09b4ebf43fcc/bucket/b8042d2f-f00f-4452-8f10-a84aadbf6893.png',
  ],
  category: 'Для дома',
  rating: 5.0,
  reviews: 0,
...
- Современный внешний вид: белый цвет гармонично впишется в любой интерьер.`,
  features: [
  ...
  specifications: [
    ...
    { label: 'Направление крепления', value: 'Правая рука' },
...
const ProductDetail16 = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-background to-muted/20">
      <Helmet>
        <title>Ключница «Рука правая белая» — Полимер-проект</title>
        <meta name="description" content="Ключница «Рука правая белая». Цена: 370₽. Стильная настенная подставка-рука для ключей, сумок и аксессуаров. Доставка по России." />
        <link rel="canonical" href="https://proekt-polimer.ru/product/16" />
        <script type="application/ld+json">{JSON.stringify({
          ...
          "offers": {
            "@type": "Offer",
            "url": "https://proekt-polimer.ru/product/16",
            "priceCurrency": "RUB",
        ...
        <script type="application/ld+json">{JSON.stringify({
          ...
          "itemListElement": [
            ...
            { "@type": "ListItem", "position": 3, "name": productData.name, "item": "https://proekt-polimer.ru/product/16" }
          ]
        })}</script>
      </Helmet>
...
export default ProductDetail16;
