...
const ProductDetail15 = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-background to-muted/20">
      <Helmet>
        <title>Ключница «Рука левая белая» — Полимер-проект</title>
        <meta name="description" content="Ключница «Рука левая белая». Цена: 370₽. Стильная настенная подставка-рука для ключей, сумок и аксессуаров. Доставка по России." />
        <link rel="canonical" href="https://proekt-polimer.ru/product/15" />
        <script type="application/ld+json">{JSON.stringify({
          ...
          "offers": {
            "@type": "Offer",
            "url": "https://proekt-polimer.ru/product/15",
            "priceCurrency": "RUB",
        ...
        <script type="application/ld+json">{JSON.stringify({
          ...
          "itemListElement": [
            ...
            { "@type": "ListItem", "position": 3, "name": productData.name, "item": "https://proekt-polimer.ru/product/15" }
          ]
        })}</script>
      </Helmet>
...
export default ProductDetail15;
